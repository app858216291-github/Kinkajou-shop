<template>
	...
	<view>
		<view class="back-btn yticon icon-zuojiantou-up" style="position: absolute;left: 17px;z-index: 9999;padding-top: 0;font-size: 17px;color: #303133;" @click="navBack"></view>
		...
		<view class="login-form">
			...
			<form @submit="formSubmit">
				<view class="form-input" style='font-size: 18px; color: #222c3fe0;'>
					登录
				</view>
				<view class="form-input">
					<input type="text" value="" placeholder="用户名/手机/电子邮箱" />
				</view>
				
				<view class="form-input">
					<input type="password" value="" placeholder="密码" @focus="passwordF_B" @blur="passwordF_B" />
				</view>
				<view class="forget-section" style="top:-20px;padding-left: 10px;padding-bottom: 10px;text-decoration:underline">
					忘记密码?
				</view>
			...
			<view class="register-section">
				还没有账号?马上
				<text @click="toRegist" style="text-decoration:underline">注册</text>
			</view>
		</view>
	</view>
</template>
