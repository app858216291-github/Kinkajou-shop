	...
	<view>
			...
			<view v-for="(item, index) in productList" :key="index" class="g-item">
				...
				<view class="right">
					...
					<view class="price-box">
						...
						<text v-if="productid!=0" class="number">x {{item.number}}</text>	
					</view>
				</view>
			</view>
			<!-- <view class="g-item">
		...
		<view class="yt-list">
			...
			<view class="yt-list-cell desc-cell">
				...
				<text class="cell-tip">{{order.orderRemark}}</text>
			...
			async onLoad(options){	
				...
				if(data==undefined){
					...
					if (this.productid!=0 & this.productid!=undefined){
						this.productList=[await this.$shop.getProduct(this.$shop.prop().serviceUrl+'/product/productListByOrder?orderid='+this.order.orderid,{})]
						this.productList[0].mount=this.productList[0].price
					}else{
						this.productList=await this.$shop.getProductList(this.$shop.prop().serviceUrl+"/product/productListByOrder?orderid="+this.order.orderid,{});
					}
					
					
					
					
					this.productList=this.productList.goodsList;
