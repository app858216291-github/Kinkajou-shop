	...
	export default {
		...
		methods: {
			...
			async loadCateList(fid, sid){
				...
				let list= await this.$shop.getCatogory("","");
			...
			async loadData(type='add', loading) {
				...
				// ---获取商品列表-this.goodsList = await this.$api.json('goodsList');
				...
				this.goodsData=await this.$shop.getProductList(this.$shop.prop().serviceUrl+'/product/productList?page='+this.page+'&pageSize='+this.pageSize+'&category='+this.sId+'&title='+this.title,{});
